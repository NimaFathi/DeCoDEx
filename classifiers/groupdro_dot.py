...
if __name__ == "__main__":
    ...
    if args.augment:
        ...
        args.model_path = "/usr/local/data/nimafh/midl2024-cfdiffusion/pretrained/exp2_DOT_classification_DRO_augmented_baseline.pth"
    else:
        args.model_path = "/usr/local/data/nimafh/midl2024-cfdiffusion/pretrained/exp2_DOT_classification_DRO.pth"
    # Device
    ...
    if args.augment:
        dataset_train_augmet = AugmentedMD(root_dir='/usr/local/data/nimafh/midl2024-cfdiffusion/final_results/Results/exp/Dot_Baseline_result',
