...
from core.image_datasets import PEDataset, BiasedPEDataset
...
if __name__ == "__main__":
	...
	parser.add_argument("--model_path", type=str, default="pretrained/pe_classification_densenet121_256.pth", help="Path to save the model")
	...
	if args.biased:
		args.model_path = f"pretrained/pe_{args.task}_densenet121_{args.image_size}_logits_biased.pth"
	else:
		args.model_path = f"pretrained/pe_{args.task}_densenet121_{args.image_size}_logits.pth"
	...
	if args.biased:
		dataset_train = BiasedPEDataset(image_size=args.image_size,
		...
		dataset_val = BiasedPEDataset(image_size=args.image_size,
							data_dir=args.data_dir,
							partition='val',
							task=args.task, # 'classification' or 'detection
							random_crop=False,
		...
		dataset_train = PEDataset(image_size=args.image_size,
							  data_dir=args.data_dir,
							  partition='train',
							  task=args.task, # 'classification' or 'detection
							  random_crop=args.random_crop,
		...
		dataset_val = PEDataset(image_size=args.image_size,
							  data_dir=args.data_dir,
							  partition='val',
							  task=args.task, # 'classification' or 'detection
							  random_crop=False,
