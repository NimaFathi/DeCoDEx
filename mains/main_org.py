...
from core.image_datasets import CheXpertDataset, PEDataset
...
def main():
    ...
    if args.dataset == 'CelebA':
        ...
        dataset = CheXpertDataset(image_size=args.image_size,
                                data_dir=args.data_dir,
                                partition='train' if args.use_train else 'val',
                                random_crop=False,
                                random_flip=False,
