...
DETECTOR_SCALES='0.6,0.9,1.2' # we are using contineous labels and student-teacher loss for the detector, hence the scales are different. You can use clean_class_cond_fn for detector with binary labels and same range of scales for classifier
